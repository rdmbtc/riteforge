...
export const TerminalLoader = ({ command = "npx rite-forge generate" }: TerminalLoaderProps) => {
  return (
    <StyledWrapper>
      <div className="card">
        <div className="wrap">
...
const StyledWrapper = styled.div`
  ...
  .cmd::before {
    ...
    overflow: hidden;
    background-color: transparent;
    animation: inputs 3s steps(15) infinite;
  }
  .cmd::after {
    content: "";
    position: relative;
    ...
    animation: cursor 0.5s step-end infinite alternate, blinking 0.5s step-end infinite;
  }
